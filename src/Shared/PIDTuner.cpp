...
void PIDScreenTuner::initButton(tunerButtons_t* tunerButtons, int xPos, float* variablePtr, const char* variableName, bool multiplier)
{
  ...
  lv_obj_align(tunerButtons->minusButton, m_buttonContainer, LV_ALIGN_OUT_BOTTOM_LEFT, xPos, -65);
  ...
  lv_obj_align(tunerButtons->plusButton, m_buttonContainer, LV_ALIGN_OUT_BOTTOM_LEFT, xPos+50, -65);
  /*Add a label to the button*/
