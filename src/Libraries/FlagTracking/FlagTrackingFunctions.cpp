...
//Fills flag arrays
void fillObjectData( vision_object obj, int objectNum, int flagColor )
{
...
void passArrayObjectData(int flagColor, int firstFilter, int secondFilter)
{
  for (int objectNum = 0; objectNum < flagObjects[flagColor][firstFilter].objectCount; objectNum++)
  {
    passObjectData(flagColor, firstFilter, secondFilter, objectNum, objectNum);
  }
