...
// {
//   public:
//   visionObjects filterArray[NUM_VISION_FILTERS][NUM_VISION_OBJECTS];
//   int objectCount;
//
//
//   void filterObjects()
//   {
//     populateObjectData(FILTER_FIRST);
//
...
//
//         default:
//         passArrayObjectData(filterNum, filterNum + 1);
//         break;
//       }
//     }
//   }
...
//   void populateObjectData(int destFlter)
//   {
...
//     {
//       passObjectData(flagColor, filterNum, filterNum + 1, objectNum, filteredObjectCount);
//       filteredObjectCount++;
//     }
//
//   }
...
//
// /*
// visionObjects rollingAvgObjects[OBJ_NUM_COLORS][NUM_VISION_OBJECTS];
//
