...
rpmMeasure::rpmMeasure(int topEncoderPort, bool reverseEncoder, double ticksPerRev,
                       double flywheelEncoderRatio) :
  m_timer(),
  m_encoder(topEncoderPort, topEncoderPort + 1, reverseEncoder),
