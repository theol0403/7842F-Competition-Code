...
void initializeDevices()
{
	...
	robot.flywheel = new FlywheelController(robot.intake, new okapi::Motor(mFlywheel), new ADIEncoder('A', 'B'), new VelMath(quadEncoderTPR * 5, std::make_shared<okapi::EmaFilter>(0.15), 10_ms, std::make_unique<Timer>()), new lib7842::velPID(0.38, 0.05, 0.045, 0.9), 0.8);
