...
void AutoBlueClose()
{
  ...
  chassisOdomController->driveToPoint(lib7842::Point{FX 1_ft, 8.2_ft}); // Move forward to second shooting position
  ...
  chassisOdomController->m_odomTracker->state.theta += 3_deg;
  chassisOdomController->driveToPoint(lib7842::Point{FX 1_ft, 10.3_ft}); //Push Bottom Flag
  chassisOdomController->driveToPoint(lib7842::Point{FX 1_ft, 8.2_ft}); //Move back
