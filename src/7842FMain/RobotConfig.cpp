...
void initializeDevices()
{
	...
	robot.vision = new VisionController(new pros::Vision(mVision), display.main->newTab("Vision"), new IterativePosPIDController(0.01, 0.00, 0.0004, 0, TimeUtilFactory::create()));
