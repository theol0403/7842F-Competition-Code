...
void initializeDevices()
{
	...
	#ifdef F_ROBOT
	robot.shooter = new ShootController(robot.intake, robot.flywheel, new pros::ADIPotentiometer('C'), 75.3 - 61, new IterativePosPIDController(0.016, 0, 0, 0, TimeUtilFactory::create()));
	#else
	...
	//robot.vision = new VisionController(new pros::Vision(mVision), display.main->newTab("Vision"), new IterativePosPIDController(0.001, 0.00, 0.0004, 0, TimeUtilFactory::create()));
