...
void initializeDevices()
{
	...
	#ifdef F_ROBOT
	robot.shooter = new ShootController(robot.intake, robot.flywheel, new pros::ADIPotentiometer('C'), 15, new IterativePosPIDController(0.016, 0, 0, 0, TimeUtilFactory::create()));
	#else
