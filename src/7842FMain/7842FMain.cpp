...
void initialize()
{
  ...
  autonSelector = new lib7842::AutonSelector(lv_scr_act(), {{"T", AutonTest}, {"Close", AutonClose}, {"Far", AutonFar}, {"C-Mid", AutonCloseMiddle}, {"MidC", AutonMiddleFromClose}, {"MidF", AutonMiddleFromFar}, {"PlatF", AutonPlatformFar}});
